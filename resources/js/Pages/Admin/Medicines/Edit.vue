<template>
  <AuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Medicine</h2>
    </template>
...
const form = useForm({
  name: props.medicines.name,
  //price: props.medicine.price,
  lprice: props.medicines.lprice,
  mprice: props.medicines.mprice,
  hprice: props.medicines.hprice,
  quantity: props.medicines.quantity,
  dosage: props.medicines.dosage,
  expdate: props.medicines.expdate,
});

function updateMedicine() {
form.put(route('admin.medicines.update', props.medicines.id));
}
</script>